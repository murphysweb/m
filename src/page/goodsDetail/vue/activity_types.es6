...
export default {
    ...
    props: ['activityinfo','activityslist','activitynum','goodslimitnum',
        ...
        'actendtime','isshowactive', 'islimitnum','goodstatusonsale','goodstatus','activityindex',"otheract",'isbiggift','userbuygift','goodsstocknumber','allgoodsstocknumber','ismultigoods','goodsid'],
    created () {
      let that =this;
