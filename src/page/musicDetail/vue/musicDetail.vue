<template>
  <div>
    ...
    <com-top-title back title="音频详情" opacity :back="ua.isDvdApp() ? false : true" :home="ua.isDvdApp() ? false : true" v-if="!ua.isDvdApp()">
      <template v-if="ua.isDvdApp()">
        <div class="left-btns" slot="left">
          <!--按钮-收起-->
    ...
    <div class="btn" v-if='!isapp'>
      <div class="btn1"><img src="//9i.dvmama.com/free/2017/08/16/time.png" alt="" @click='dialog'></div>
      ...
      <div class="btn3" >
        <div class="small_icon" v-if='!isPlay'><img src="//9i.dvmama.com/free/2017/08/16/playBtn.png" alt="" @click='playAudio(-100)'></div>
        <div class="small_icon" v-if='isPlay'><img src="//9i.dvmama.com/free/2017/08/18/timeOut.png" alt="" @click='playAudio(-100)'></div>
      </div>
    ...
    <div class="look_more" @click='goAlbumId' v-if='!isapp'>
      ...
      <div class="look_icon"><img src="//9i.dvmama.com/free/2017/08/28/entry.png" alt=""></div>
    </div>
...
//                    alert("加载完毕");
    ...
    mounted: function () {
      ...
      this.$nextTick(function(){
        ...
        let sortNo = getQuery('sortNo') || '0';
        let musicId = getQuery('musicId');
        if(musicId) {
          var obj = {
...
<style lang="sass" lang="scss" rel="stylesheet/scss">
  ...
  .mask_btn{
    ...
    margin:0 auto;
    margin-top: 0.25rem;
    background:url("//9i.dvmama.com/free/2017/08/21/Rectangle6.png");
