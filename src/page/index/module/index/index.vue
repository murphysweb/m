<template>
  <div class="index_inner">
    <!--头部-->
    <index-head :usersta="usersta" :menudata='menudata' :data='headData' v-if='!app' v-on:categorya="changeCategory"
                :style-list="aa"></index-head>
    <div style='height: 80px' v-if='!app' class="background"></div>
    <n-progress></n-progress>
    <!--内容-->
    <index-feed :data="feedData" :res="res" v-if='!loadFlag && !unLoadFlag'>
    </index-feed>
    ...
    <div class="other_info">
      ...
      <div class="downAppWrap" v-if="iftips&&!app" v-on:click="closeTips">
        <div class="downApp" v-on:click.stop="events">
          <img v-if="isWechart" v-lazy="'//9i.dvmama.com/free/2017/06/13/index_erweima.png'">
          <img v-else v-lazy="'//9i.dvmama.com/free/2017/06/13/index_erweima.png'" alt="" @touchstart="tipstouchstart"
      ...
      <div class="getReward" v-if="getRewardtips && rewardData.imgUrl != ''">
        <a :href="rewardData.command.content">
          <img v-lazy="rewardData.imgUrl" alt="">
          <!--<img v-lazy="'http://9i.dvmama.com/goods/2017/06/06/800_384_b7862b07fef7e7dcd0c806e5e648f542.jpg'" alt="">-->
    ...
    <!-- 微信邀请弹框 -->
    <wechatinvite v-if="wechatFlag" :wechatdata="wechatdata" @close="closeWechat"></wechatinvite>

    <!-- 新会员引导 -->
    <img ref="newMemberIcon" v-lazy="userIntro.icon" v-if="userIntro && userIntro.icon && !app" class="newMemberIcon"
         @click="goMemberGuidePage">
  </div>
</template>
