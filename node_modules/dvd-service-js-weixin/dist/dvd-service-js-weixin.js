...
import params from 'dvd-base-js-param';
...
export default {
  ...
  setShareInfo(param, response) {
    ...
    function shareInfoPost(msg) {
      ...
      if (shareSource) {
        ...
        if (window.gio) {
          gio('track', 'wechatShare', { shareSource, shareSourceName });
        }
      }
    }
  },
  ...
  goAuthPage(show) {
    ...
    var referer_path = decodeURIComponent(params.get('referer'));
