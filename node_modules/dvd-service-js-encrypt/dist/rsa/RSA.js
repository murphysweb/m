...
exports.decryptedString = exports.encryptedString = exports.RSAKeyPair = undefined;

var _BigInt = require('./BigInt');

var _Barrett = require('./Barrett.js');
 ...
 */{
   ...
   */
  this.e = (0, _BigInt.biFromHex)(encryptionExponent);
  this.d = (0, _BigInt.biFromHex)(decryptionExponent);
  this.m = (0, _BigInt.biFromHex)(modulus);
  /*
  ...
  if (typeof keylen != 'number') {
    this.chunkSize = 2 * (0, _BigInt.biHighIndex)(this.m);
  } else {
   ...
   */
  this.barrett = new _Barrett.BarrettMu(this.m);
}
 ...
 */{
  ...
  for (i = 0; i < al; i += key.chunkSize) {
    ...
    if (encodingtype == 1) {
      text = (0, _BigInt.biToBytes)(crypt);
    } else {
      text = key.radix == 16 ? (0, _BigInt.biToHex)(crypt) : biToString(crypt, key.radix);
    }
    result += text;
  }
  /*
 ...
 */{
  ...
  for (i = 0; i < blocks.length; ++i) {
     ...
     */
    if (key.radix == 16) {
      bi = (0, _BigInt.biFromHex)(blocks[i]);
    } else {
      bi = (0, _BigInt.biFromString)(blocks[i], key.radix);
    }
    /*
     ...
     * plaintext.
     */
    for (j = 0; j <= (0, _BigInt.biHighIndex)(b); ++j) {
