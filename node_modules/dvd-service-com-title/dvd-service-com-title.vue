<template>
  <!--顶部标题-->
  <div class="dvd-service-com-title" ref="comTopTitle"
       v-if="alwaysShow || !(ua.isDvdApp() && ua.compareVersion(ua.getDvdAppVersion(), '5.2.0') < 0)"
       :class="{'animate-out': animateOut, 'animate-in': animateIn,'show-bg-btn': opacity && scrollTop < 200}">
    ...
    <!--内容面板-->
    <div class="panel" ref="panel" :class="{'bottom-line': this.bottomLine}"
         :style="{display: hideBar ? 'none' : null, opacity: opacity ? 0 : null}">
      <!--中间标题区域-->
    ...
    <div class="right-btn-wrapper">
      ...
      <span class="btn home" @click="homeInterClick" v-if="showHome"
            :style="{backgroundImage: homeImg ? 'url('+homeImg+')' : null}"></span>
      <!--分享（单独制定或指定了分享赚钱）-->
...
<style lang="sass" lang="scss" rel="stylesheet/scss">
  ...
  .dvd-service-com-title {
    ...
    .left-btn-wrapper, .right-btn-wrapper {
      ...
      .btn {
        ...
        /* 按钮-返回 */
        &.back {
          background-image: url(./img/title-btn-back.png);
        }

        /* 按钮-首页 */
        &.home {
          background-image: url(./img/title-btn-home.png);
        }

        /* 按钮-分享 */
        &.share {
          background-image: url(./img/title-btn-share.png);
        }
        ...
        &.share-money {
          ...
          i {
            ...
            width: 17px;
            height: 16px;
            background: url(./img/title-btn-share-money.png) no-repeat;
        ...
        /* 按钮-搜索 */
        &.search {
          background-image: url(./img/title-btn-search.png);
        }
      }
    }
  ...
  /* 按钮切换为带背景色的按钮 */
  .dvd-service-com-title.show-bg-btn {
    .left-btn-wrapper, .right-btn-wrapper {
      .btn {
        /* 按钮-返回 */
        &.back {
          background-image: url(./img/title-btn-back-bg.png);
        }

        /* 按钮-首页 */
        &.home {
          background-image: url(./img/title-btn-home-bg.png);
        }

        /* 按钮-分享 */
        &.share {
          background-image: url(./img/title-btn-share-bg.png);
        }
